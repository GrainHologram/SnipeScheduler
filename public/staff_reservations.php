...
<?php endif; ?>
        ...
        ?>
        <form method="get" action="<?= h($actionUrl) ?>" id="reservation-history-filter-form">
        ...
        <div class="res-history-body">
            <div class="res-history-search-header">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <input type="text"
                           name="q"
                           form="reservation-history-filter-form"
                           class="form-control"
            ...
            <?php if (empty($reservations)): ?>
                <div class="panel-empty-state">
                    ...
                    <p class="panel-empty-text">No reservations match your filters.</p>
                </div>
            <?php else: ?>
